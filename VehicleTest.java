...
class VehicleTest {
    ...
    @BeforeEach
    void setUp() {
        jeep1 = new Car("Jeep", 2019);
        jeep2 = new Car("Jeep", 2010);
        benz = new Car("Benz", 2020);
        bike1 = new Bike("Trek", 1999);
        bike2 = new Bike("Giant", 1999);
        bike3 = new Bike("Giant", 2020);
    }
    ...
    void testRefuel() {
        ...
        jeep1.refuel(101);  // Overfilling
        assertEquals(jeep1.getGasRemained(), 200);

        jeep1.refuel(1);    // Refueling after full tank
        assertEquals(jeep1.getGasRemained(), 200);

        jeep1.run(5);       // Consume some gas
        assertEquals(jeep1.getGasRemained(), 150);

        jeep1.refuel(30);   // Add some gas back
        assertEquals(jeep1.getGasRemained(), 180);
    }
